...
<div>
	...
	<%-- <p align="center">
<a href="/books/BookServlet?method=findByCategory" style="margin: 40px; font-size: 20px;">首页</a>
<a href="<c:url value='/jsps/book/add.jsp'/>" style="margin: 40px; font-size: 20px;">添加图书</a>
<a href="<c:url value='/jsps/book/gj.jsp'/>" style="margin: 40px; font-size: 20px;">高级搜索</a>
<a href="<c:url value='/UserServlet?method=quit'/>" style="margin: 40px; font-size: 20px;">退出登录</a>
</p> --%>
</div>
<div class="divBook">
<a href=""></a>
