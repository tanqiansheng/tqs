...
<div class="center top_c"><marquee behavior="scroll" direction="left" loop="-1" scrollamount="6" scrollamount="6" onmouseover="this.stop()" onmouseout="this.start()" style="font-size: 30px;color: red">你好，欢迎来到谭茜升的图书商城！</marquee></div>
	</div>
	<!-- 顶部 E -->
	<!-- logo B -->
	<div class="logo">
