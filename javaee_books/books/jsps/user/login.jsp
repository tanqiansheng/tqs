...
<body>
	...
	<div class="main center">
		...
		<div class="m_right fr">
			...
			<div class="uName_pwd">
				<input class="txt" type="text" placeholder="请输入昵称" id="loginname" name="loginname" value="${user.loginname}"> <label id="loginnameError" class="error" ></label>
				<input class="btn" type="password" placeholder="请输入密码" id="loginpass" name="loginpass" value="${user.loginpass}"> <label id="loginpassError" class="error"></label>
			</div>
			<div class="remember">
